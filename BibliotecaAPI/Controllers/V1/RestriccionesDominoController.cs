...
namespace BibliotecaAPI.Controllers.V1
{
    ...
    public class RestriccionesDominoController : ControllerBase
    {
        private readonly ApplicationDbContext context;
        private readonly IServiciosUsuarios serviciosUsuarios;

        public RestriccionesDominoController(ApplicationDbContext context, IServiciosUsuarios serviciosUsuarios)
        {
        ...
        public async Task<ActionResult> Put(int id,
            RestriccionDominioActualizarDTO restriccionDominioActualizarDTO)
        {
            ...
            restriccionDB.Dominio = restriccionDominioActualizarDTO.Dominio;
